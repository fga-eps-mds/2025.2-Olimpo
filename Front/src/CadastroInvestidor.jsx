          ...
          <form className="formulario formulario-scroll">
            ...
            {empresa === true && (
              <>
                ...
                <input type="text" className="input" placeholder="Digite o CNPJ" autoComplete="cnpj" required />
              </>
            )}
            ...
            <div style={{display: 'flex', alignItems: 'center', marginBottom: 15, marginLeft: 16}}>
              ...
              <span style={{
                marginLeft: 8,
                color: senha && confirmaSenha && senha === confirmaSenha ? '#FDC700' : '#fff',
                fontWeight: senha && confirmaSenha && senha === confirmaSenha ? 'bold' : 'normal',
                fontSize: '0.85rem'
              }}>
                As senhas coincidem
              </span>
