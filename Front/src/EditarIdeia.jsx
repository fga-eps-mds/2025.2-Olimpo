        ...
        <div className={styles['form-container']}>
          <form className={styles['post-form']}>
            ...
            <textarea
              ...
              placeholder="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vitae justo vitae urna convallis interdum. Curabitur id sapien non justo consequat fermentum. Maecenas vel lacus pulvinar, malesuada velit id, dictum purus. Vivamus ac neque vel libero tempor suscipit. Integer venenatis orci a velit fringilla, vitae volutpat ipsum facilisis. Suspendisse potenti. Nunc dapibus orci eu mauris rutrum, vitae hendrerit sapien hendrerit."
            />
